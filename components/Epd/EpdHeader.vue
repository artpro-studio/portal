    ...
    <div class="header_info">
      <div class="user">
        <div class="image" @click="modalTrue = !modalTrue">
          <img src="@/libs/img/user.png" alt v-if="!$store.state.user.user.user_icon" />
          <img v-else :src="'http://45.67.57.180' + $store.state.user.user.user_icon" alt />
        </div>
        <div class="user_info" @click="modalTrue = !modalTrue">
          <p v-if="$store.state.user.user.lastName != ''">
