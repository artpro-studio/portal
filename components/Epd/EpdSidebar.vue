<template>
    <div class="sidebar" :class="{'active':sidebarBool}" >
        <div class="burger" @click="sidebarBool = !sidebarBool">
            <span></span>
            <i>Закрыть меню</i>
        </div>
        <nuxt-link to="/personal/profile/" class="user">
            <div class="image">
                <img src="@/libs/img/user.png" alt="">
            </div>
            <div class="user_info">
                <p v-if="$store.state.user.user.firstName != ''">{{$store.state.user.user.firstName}}  {{$store.state.user.user.lastName}}</p>
                    ...
                    <li>
                        <a href="" class="active">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
                                 viewBox="0 0 490.065 490.065" style="enable-background:new 0 0 490.065 490.065;" xml:space="preserve">
                                    <g>
                                        <g>
    ...
    data(){
        return{
            ...
            menuTop:[
                ...
                {
                    id: 2, title: 'На JkhPay', url: '/'
                },
                {
                    id: 3, title: 'О сервисе', url: '/'
                },
                {
                    id: 4, title: 'Поддержка', url: '/'
                },
                {
...
.lk_page .sidebar .user .image img{
    width: 27px;
    height: 27px;
}
