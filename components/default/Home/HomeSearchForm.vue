  ...
  <div class="search_home">
    <div class="search_home__top">
      <div class="text">
        ...
        <p v-if="typePage != true">{{$t('description')}}</p>
        <p v-else>{{$t('description2')}}</p>
      </div>
      <div class="search_home__info">
        <a href="mailto:info@portal-jkh.ru" class="search_home_mail" v-if="isChecked != 'true'"><span>{{$t('infoText')}}</span><img src="/img/default/mail.svg" alt="">info@portaljkh.ru</a>
...
<script>
  ...
  import serviceModal from "/components/Default/Portal/ServiceModal";
        ...
        if(this.$route.query.region){
          let formData =  {
            and:{
              ...
              settlement: this.$route.query.settlement,
...
<i18n>
  {
    "ru": {
      ...
      "description": "Заполните поле поиска чтобы найти дом в нашей системе",
      "description2": "Заполните поле поиска чтобы найти организацию в нашей системе",
      "infoText": "Возникли вопросы?",
      "inputSearch": "Введите ваш адрес",
      "inputSearchOrg": "Введите название организации",
      "region": "Регион",
      ...
      "buttonName": "Перейти к дому",
      "buttonNameOrg": "Перейти к организации",
    ...
    "ch": {
      ...
      "description2": "Пирĕн системăра çурт тупас тесе кашни йĕркине çырса тухăр",
